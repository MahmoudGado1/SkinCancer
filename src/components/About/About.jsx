    ...
    <div className="about container">
      <div className="leftAbout">
        ...
        <div className="aboutBody">
          ...
          <Button onClick={()=>navigate("/doctors")}>Find Doctor <span> <ArrowRight/> </span></Button>
          <Button onClick={()=>navigate("/about")} variant="secondary">Go To About <span><Layers/></span>   </Button>
        </div>
      </div>
